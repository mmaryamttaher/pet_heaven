...
// Get hotels in Cairo
$query = "SELECT * FROM hotels WHERE status = 'active' AND city LIKE '%Cairo%' ORDER BY rating DESC, price_per_day ASC";
...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && !empty($_GET['search'])) {
    ...
    $search_query_param = "SELECT * FROM hotels WHERE status = 'active' AND city LIKE '%Cairo%' AND (name LIKE ? OR description LIKE ?) ORDER BY rating DESC";
    ...
    <div id="popularcities">
        ...
        <div  id="cards">
            ...
            if (empty($display_hotels)):
                ...
                <div class="card ">
                    <div class="card-img">
                      <img src="imgs/AHP_8783.jpg" alt="h1" >
                    </div>
                    <div class="details">
                        <h4>Kingdom of Pets</h4>
                        <p>Madinat nasr,Cairo</p>
                        <div class="next">
                         <p>900 per day</p>
                         <a href="kingdom.php"><button class="btn btn-dark">>></button></a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
