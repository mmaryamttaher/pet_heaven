...
// Get hotels in Suez
$query = "SELECT * FROM hotels WHERE status = 'active' AND city LIKE '%Suez%' ORDER BY rating DESC, price_per_day ASC";
...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && !empty($_GET['search'])) {
    ...
    $search_query_param = "SELECT * FROM hotels WHERE status = 'active' AND city LIKE '%Suez%' AND (name LIKE ? OR description LIKE ?) ORDER BY rating DESC";
...
<head>
    ...
    <title>Cairo</title>
    <link rel="stylesheet" href="suez.css">
    ...
    <div id="popularcities">
        ...
        <div  id="cards">
            ...
            if (empty($display_hotels)):
                ...
                <div class="card ">
                    <div class="card-img">
                      <img src="imgs/pet-boarding.jpg" alt="h1" >
                    </div>
                    <div class="details">
                        <h4>Porto Empire</h4>
                        <p>Port Tewfik Memorial, 23-Jul, Suez, Suez Governorate 43511</p>
                        <div class="next">
                         <p>1300 per day</p>
                         <a href="porto.php"><button class="btn btn-dark">>></button></a>
                        </div>
                    </div>
                </div>
                <div class="card ">
                    <div class="card-img">
                      <img src="imgs/cattery-_01.jpg" alt="h1" >
                    </div>
                    <div class="details">
                        <h4>Just Like Home</h4>
                        <p>Arbaeen, Suez Governorate 8160021</p>
                        <div class="next">
                         <p>1000 per day</p>
                         <a href="just.php"><button class="btn btn-dark">>></button></a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
